...
LINKABLES = %w(.ackrc .agignore .bashrc .bundle .gemrc .git_template .gitconfig .gitignore_global .gvimrc .hgrc .irbrc .profile .pryrc .railsrc .rspec .screenrc .ssh/common_config .vim .vimrc .zprofile .zsh .zshenv .zshrc).freeze
